...
class AGENT:
    ...
    def __init__(self, obs_shape, action_shape, device, lr, feature_dim,
       ...
       # data augmentation
        ...
        self.apply_strong_aug = nn.Identity() if len(strong_augs)==0 else augmentations.compose_augs(strong_augs) 
    ...
    def update(self, replay_iter, step):
        ...
        # augment
        obs = self.apply_strong_aug(self.aug(obs.float()))
        next_obs = self.apply_strong_aug(self.aug(next_obs.float()))
